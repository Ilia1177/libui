...
void ui_box_handler_add(ui_boxhandler_t**, void(*fn)(ui_box_t*, SDL_Event*, void*));
void ui_box_event_fire(ui_boxhandler_t*, ui_box_t*, SDL_Event*, void*);
...
void		ui_box_on_click_up_handler(ui_box_t *, SDL_Event* e, void* data);
void		ui_box_on_click_down_handler(ui_box_t *,  SDL_Event* e, void* data);
