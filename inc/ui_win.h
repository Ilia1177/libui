...
typedef struct ui_win_s {
	...
	void(*on_key_down)(struct ui_win_s*, SDL_Event*);
	void(*on_key_up)(struct ui_win_s*, SDL_Event*);
	void(*on_mouse_down)(struct ui_win_s*, SDL_Event*);
	void(*on_click_up)(struct ui_win_s*, SDL_Event*);
	void(*on_mouse_wheel)(struct ui_win_s*, SDL_Event*);
	void(*on_mouse_motion)(struct ui_win_s*, SDL_Event*);
	void(*on_windows_event)(struct ui_win_s*, SDL_Event*);
...
void	ui_win_on_click_up_handler(ui_win_t*, SDL_Event*);
void	ui_win_on_click_down_handler(ui_win_t*, SDL_Event*);
void	ui_win_on_mouse_motion_handler(ui_win_t*, SDL_Event*);
